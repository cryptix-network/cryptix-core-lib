...
var HDPrivateKey = cryptixcore.HDPrivateKey;
var HDPublicKey = cryptixcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = cryptixcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(cryptixcore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(cryptixcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      cryptixcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = cryptixcore.PublicKey.fromPoint;
      cryptixcore.PublicKey.fromPoint = function() {
        cryptixcore.PublicKey.fromPoint = unstubbed;
