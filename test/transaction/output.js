...
var BufferWriter = cryptixcore.encoding.BufferWriter;
var BufferReader = cryptixcore.encoding.BufferReader;
...
describe("Output", function() {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function() {
    ...
    var br = new cryptixcore.encoding.BufferReader(invalidOutputScript);
