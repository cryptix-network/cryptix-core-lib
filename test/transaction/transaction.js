...
var BN = cryptixcore.crypto.BN;
var Transaction = cryptixcore.Transaction;
var Signature = cryptixcore.Signature;
var Input = cryptixcore.Transaction.Input;
var Output = cryptixcore.Transaction.Output;
var PrivateKey = cryptixcore.PrivateKey;
var Script = cryptixcore.Script;
var Address = cryptixcore.Address;
var Networks = cryptixcore.Networks;
var Opcode = cryptixcore.Opcode;
var errors = cryptixcore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    var tx = cryptixcore.Transaction({
    ...
    tx.inputs[0].should.be.instanceof(cryptixcore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(cryptixcore.Script);
