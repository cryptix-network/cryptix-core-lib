...
[
	...
	"cryptix:qqnash4vvcpx3s4qrf47p3rkcd4230sxz7506ejpt4gkpm2fh9xsumafqp07p",
	"cryptix:qqwxqxwc0w54vsxlwyzt74enqq4e7d6mjp99l3te48r6ak4auehnqzae9a6uw",
	"cryptix:qztdywdh8d9zjztdn8kdvckgch0e8p47gendyzks3lx2n8r70hktujwsy6ums",
	"cryptix:qr0we0jumdfr25wpp9her3lk4nere24jmsfvew4z6gfwrj3dhhpny89xs7g6j",
	"cryptix:qpdpduavrg6j39e8dn6rsr68yu4p6x6ju695up0p4r4gay0wymm4cged8p758"
].map(addr=>{
...
Transaction.prototype.checkedSerialize = function(opts) {
	...
	if (serializationError) {
		serializationError.message += ' - For more information please see: ' +
			'https://cryptix-network.org/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by cryptixcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a cryptixcore Address object. The
 * same is true for `script`, which can be a string or a cryptixcore Script.
 *
