 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'cryptixtest'.
 */
...
const cryptixNetworks = ['cryptix', 'cryptixdev', 'cryptixreg', 'cryptixtest', 'cryptixsim'];

cryptixNetworks.map((str) => {
  addNetwork({
    name: str,
    prefix: str,
    pubkeyhash: 0x00, // publickey hash prefix
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with cryptix
    scripthash: 0x05,
