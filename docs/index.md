...
var imported = cryptixcore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new cryptixcore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new cryptixcore.URI(paymentInfo).toString();
```
